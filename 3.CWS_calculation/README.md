...
## Scripts & routine
The Critical Wind Speed for each forest pixel is calculated in parallel with the find_CWS.sh which uses find_CWS_for_tile.sh. The find_CWS_for_tile.sh relies on the R script FGrou_CWS_SR16.R
